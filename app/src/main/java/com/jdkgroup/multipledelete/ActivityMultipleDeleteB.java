...
import com.jdkgroup.utils.AlertDialogHelper;
import com.jdkgroup.utils.RecyclerItemClickListener;

import java.util.ArrayList;

public class ActivityMultipleDeleteB extends AppCompatActivity implements AlertDialogHelper.AlertDialogListener{

    ActionMode mActionMode;
    Menu context_menu;
    FloatingActionButton fab;
    RecyclerView recyclerView;
    AdapterMultipleDeleteB multiSelectAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multiple_delete);
        ...
        multiSelectAdapter = new AdapterMultipleDeleteB(this,user_list,multiselect_list);
    ...
    public void data_load() {
        String name[] = {"Kamlesh", "Nikunj", "Nayan", "Kamal", "Dax", "Jalpan"};
